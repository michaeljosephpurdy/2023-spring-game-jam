...
local SEGMENTS = {
  ...
  { { OVAL_OFFICE, ANDY_JASSY, MIKE_PURDY }, "Me:\nPlayers could hit 'n' key if the\nin-game physics aren't working\nthe way they should.", 1, .7 },
  { { OVAL_OFFICE, ANDY_JASSY, MIKE_PURDY }, "Me:\nThat way they don't feel robbed\nif the button doesn't trigger\nwhen it should have.", 1, .7 },
  { { OVAL_OFFICE, MIKE_PURDY, ANDY_JASSY }, "Andy Jassy:\nNow that's a very\nCustomer Obsessed approach.", 1.5, .55 },
  { { OVAL_OFFICE, ANDY_JASSY, MIKE_PURDY }, "Me:\nBut I won't have time to work on\nmy game if I solve these puzzles\nto rescue the President...", 1, .7 },
  { { OVAL_OFFICE, MIKE_PURDY, ANDY_JASSY }, "Andy Jassy:\nThis,", .5, .55, true},
